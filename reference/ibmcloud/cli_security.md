...
# Commands for Managing {{site.data.keyword.Bluemix_notm}} infrastructure Security
...
<caption>Table 1. {{site.data.keyword.Bluemix_notm}} infrastructure security commands</caption>

 <thead>
 <th colspan="5">{{site.data.keyword.Bluemix_notm}} infrastructure security commands</th>
 </thead>
 <tbody>
 <tr>
