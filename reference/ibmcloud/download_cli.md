...
* For **Windows&trade;**, copy and paste the following command to a [Windows&trade; PowerShell 5](https://msdn.microsoft.com/en-us/powershell/scripting/getting-started/getting-started-with-windows-powershell){: external} terminal console and run it:
   ```bash
