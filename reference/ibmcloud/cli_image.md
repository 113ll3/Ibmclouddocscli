...
# Commands for Managing {{site.data.keyword.Bluemix_notm}} infrastructure Image
...
<caption>Table 1. {{site.data.keyword.Bluemix_notm}} infrastructure image commands</caption>
 <thead>
 <th colspan="6">{{site.data.keyword.Bluemix_notm}} infrastructure image commands</th>
 </thead>
 <tbody>
 <tr>
