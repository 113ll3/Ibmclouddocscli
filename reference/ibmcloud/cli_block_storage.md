...
# Commands for Managing {{site.data.keyword.Bluemix_notm}} infrastructure Block storage
...
<caption>Table 1. {{site.data.keyword.Bluemix_notm}} infrastructure Block storage</caption>
 <thead>
 <th colspan="6">{{site.data.keyword.Bluemix_notm}} infrastructure Block storage</th>
 </thead>
 <tbody>
 <tr>
