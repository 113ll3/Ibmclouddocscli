...
# Catalogo, fatture e plug-in CLI
{: #ibmcloud_commands_settings}

Utilizza i seguenti comandi per gestire i plug-in CLI, l'utilizzo/fatturazione e il catalogo {{site.data.keyword.Bluemix_notm}}.
{: shortdesc}
