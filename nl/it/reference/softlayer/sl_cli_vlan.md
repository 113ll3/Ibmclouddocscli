...
<caption>Tabella 1. Comandi VLAN dell'infrastruttura {{site.data.keyword.BluSoftlayer_notm}}</caption>
...
](/docs/cli/reference/softlayer/sl_cli_vlan.html#sl_vlan_options)</td>
 </tr>
   </tbody>
 </table>
