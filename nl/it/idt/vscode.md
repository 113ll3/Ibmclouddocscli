...
Per utilizzare l'estensione IBM Developer Tools per Visual Studio Code, sul tuo sistema dovrai installare anche il plug-in della [CLI {{site.data.keyword.Bluemix_notm}} ](https://plugins.ng.bluemix.net/ui/home.html) e della [CLI IBM Developer](index.html).
