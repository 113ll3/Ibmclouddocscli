...
* Utilisez la console {{site.data.keyword.dev_console}}.
	...
	1. Sélectionnez votre [application ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cloud.ibm.com/resources) dans la console {{site.data.keyword.dev_console}}.
