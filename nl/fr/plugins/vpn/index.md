...
Les instructions qui suivent s'appliquent au plug-in d'interface de ligne de commande Cloud Foundry (cf). Pour utiliser le plug-in avec le plug-in d'interface de ligne de commande {{site.data.keyword.Bluemix_notm}}, voir [Plug-in {{site.data.keyword.vpn_short}} pour l'interface de ligne de commande {{site.data.keyword.Bluemix_notm}}](https://console.{DomainName}/docs/cli/plugins/bx_vpn/index.html).

## Installation du plug-in d'interface de ligne de commande cf
Avant de commencer, installez l'interface de ligne de commande cf. Pour plus d'informations, voir [Interface de ligne de commande Cloud Foundry](https://console.{DomainName}/docs/cli/downloads.html).
...
1. Téléchargez le plug-in {{site.data.keyword.vpn_short}} pour votre plateforme à partir du [référentiel de plug-in d'interface de ligne de commande IBM Bluemix](http://plugins.ng.bluemix.net/ui/repository.html#cf-plugins).
...
1. Ajoutez le référentiel Bluemix aux référentiels de l'interface de ligne de commande Cloud Foundry. Exécutez la commandes suivante :
...
2. Exécutez la commande suivante :
	...
	```
## Affichage de la liste des commandes de service IBM VPN
...
* [Interface de ligne de commande Cloud Foundry ![External link icon](../../../icons/launch-glyph.svg)](https://console.{DomainName}/docs/cli/downloads.html){: new_window}
