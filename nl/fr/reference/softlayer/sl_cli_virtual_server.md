...
# Commandes de l'interface CLI pour le serveur virtuel
...
<caption>Tableau 1. Commandes de serveur virtuel d'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
