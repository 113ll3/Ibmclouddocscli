...
# Commandes de l'interface CLI securitygroup
...
<caption>Tableau 1. Commandes securitygroup de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
 <th colspan="5">Commandes securitygroup de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</th>
 </thead>
 <tbody>
 <tr>
