...
# Commandes de l'interface CLI pour le réseau VLAN
...
<caption>Tableau 1. Commandes de réseau local virtuel de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
