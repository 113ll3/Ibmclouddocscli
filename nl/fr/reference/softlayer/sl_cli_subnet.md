...
# Commandes de l'interface CLI pour le sous-réseau
...
<caption>Tableau 1. Commandes de sous-réseau de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
