...
# Commande de l'interface CLI pour les adresses IP globales
...
<caption>Tableau 1. Commandes pour les adresses IP globales de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
 <th colspan="6">Commandes pour les adresses IP globales de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</th>
 </thead>
 <tbody>
 <tr>
