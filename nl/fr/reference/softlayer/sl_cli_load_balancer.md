...
# Commandes de l'interface CLI pour l'équilibreur de charge
...
<caption>Tableau 1. Commandes d'équilibreur de charge de l'infrastructure {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
