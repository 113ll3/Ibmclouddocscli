...
# CDN de l'infrastructure {{site.data.keyword.Bluemix_notm}}

Les commandes suivantes permettent de gérer les comptes dans le service CDN de l'infrastructure {{site.data.keyword.Bluemix_notm}}.
{: shortdesc}
