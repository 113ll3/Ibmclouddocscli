...
Die nachfolgenden Anweisungen sind für das Plug-in für die Cloud Foundry-Befehlszeilenschnittstelle vorgesehen. Informationen zur Verwendung des Plug-ins mit dem Plug-in für die {{site.data.keyword.Bluemix_notm}}-Befehlszeilenschnittstelle finden Sie unter [{{site.data.keyword.vpn_short}}-Plug-in für die {{site.data.keyword.Bluemix_notm}}-Befehlszeilenschnittstelle](https://console.{DomainName}/docs/cli/plugins/bx_vpn/index.html). 

## Plug-in für die Befehlszeilenschnittstelle 'cf' installieren
Vor dem Beginn müssen Sie die Befehlszeilenschnittstelle 'cf' installieren. Weitere Informationen finden Sie unter [Cloud Foundry-Befehlszeilenschnittstelle](https://console.{DomainName}/docs/cli/downloads.html). 
...
1. Laden Sie das {{site.data.keyword.vpn_short}}-Plug-in für Ihre Plattform aus dem [IBM Bluemix-CLI-Plug-in-Repository](http://plugins.ng.bluemix.net/ui/repository.html#cf-plugins) herunter. 
...
### Aus dem Bluemix-Repository installieren

1. Fügen Sie das Bluemix-Repository zu den Cloud Foundry-CLI-Repositorys hinzu. Verwenden Sie den folgenden Befehl: 
...
2. Führen Sie den folgenden Befehl aus:
	...
	```
## Liste der Befehle des IBM VPN-Service
...
**-auth:** Autorisierungsalgorithmus. Werte: sha1 oder sha256
