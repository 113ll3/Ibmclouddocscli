...
# CLI-Befehle für die Sicherheitsfunktion
...
<caption>Tabelle 1. Befehle für die Sicherheitsfunktion der Infrastruktur für {{site.data.keyword.BluSoftlayer_notm}}</caption>
