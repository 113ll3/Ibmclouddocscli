...
<caption>Tabelle 1. Befehle für virtuelle Server der Infrastruktur für {{site.data.keyword.Bluemix_notm}}</caption>
 <thead>
 <th colspan="6">Infrastruktur für {{site.data.keyword.Bluemix_notm}} - Virtual-Server-Befehle</th>
 </thead>
 <tbody>
 <tr>
