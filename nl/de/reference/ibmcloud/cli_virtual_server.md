...
# {{site.data.keyword.Bluemix_notm}}-Infrastruktur - Virtual Server

Verwenden Sie die folgenden Befehle, um Virtual Server-Instanzen der {{site.data.keyword.Bluemix_notm}}-Infrastruktur zu verwalten.
{: shortdesc}
