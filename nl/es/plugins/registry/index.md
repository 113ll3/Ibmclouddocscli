...
Para obtener más información sobre cómo utilizar la {{site.data.keyword.registrylong_notm}} CLI, consulte [Iniciación a {{site.data.keyword.registrylong_notm}}](../../../services/Registry/index.html).
