...
<dl>
  ...
  <dd>Nombre o ID del servicio. Para mostrar una lista de ofertas de servicio, utilice el [mandato](/docs/cli/reference/ibmcloud?topic=cloud-cli-ibmcloud_catalog#ibmcloud_catalog_service_marketplace) `ibmcloud catalog service-marketplace`.</dd>
  ...
  <dd>Tipos de puntos finales de servicio. Los valores posibles son 'public', 'private', 'public-and-private'.</dd>
</dl>
...
<dl>
  ...
  <dd>Tipo de punto final de servicio. Los valores posibles son 'public', 'private'.</dd>
  <dt>-f, --force</dt>
...
<dl>
  ...
  <dt>--resource-id</dt>
  <dd>CRN del recurso al que se van a adjuntar las etiquetas; para recursos de infraestructura clásica, es el ID del recurso. Para obtener el CRN o el ID del recurso, utilice el mandato `ibmcloud resource search`.</dd>
  <dt>--resource-type</dt>
...
<dl>
  ...
  <dt>--resource-id</dt>
  <dd>CRN del recurso del que se van a desvincular las etiquetas; para recursos de infraestructura clásica, es el ID del recurso. Para obtener el CRN o el ID del recurso, utilice el mandato `ibmcloud resource search`.</dd>
  <dt>--resource-type</dt>
