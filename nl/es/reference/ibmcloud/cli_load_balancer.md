...
Utilice los mandatos siguientes para gestionar los equilibradores de carga en el servicio de equilibrador de carga de la infraestructura clásica de {{site.data.keyword.Bluemix_notm}}.
{: shortdesc}
