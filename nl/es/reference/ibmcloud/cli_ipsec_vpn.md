...
Utilice los mandatos siguientes para gestionar los túneles VPN de IPSec en el servicio de VPN de IPSec de la infraestructura de {{site.data.keyword.Bluemix_notm}}.
{: shortdesc}
