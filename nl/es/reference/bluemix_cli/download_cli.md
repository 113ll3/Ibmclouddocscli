...
## Utilización del instalador
{: #installer}

Para instalar la CLI de {{site.data.keyword.Bluemix_notm}} simplemente descargue el instalador:

| Versión |  Fecha de última actualización | Descargas | 
|---------|-----------|-----------|
