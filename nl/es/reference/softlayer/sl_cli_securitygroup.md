...
# Mandatos de CLI de Securitygroup
...
<caption>Tabla 1. Mandatos de securitygroup de infraestructura de {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
 <th colspan="5">Mandatos de securitygroup de infraestructura de {{site.data.keyword.BluSoftlayer_notm}}</th>
 </thead>
 <tbody>
 <tr>
