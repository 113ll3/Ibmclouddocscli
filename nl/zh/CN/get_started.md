...
1. 选择要下载的适用于您操作系统的安装程序
   ...
   **32 位发行版及先前版本可以在[此处](/docs/cli/reference/ibmcloud/all_versions.html)找到
...
* [用于下载和安装 {{site.data.keyword.Bluemix_notm}} CLI 的更多选项](/docs/cli/reference/ibmcloud/download_cli.html)
* [使用插件扩展 {{site.data.keyword.Bluemix_notm}} CLI 功能](/docs/cli/reference/ibmcloud/extend_cli.html)
* [所有版本的 {{site.data.keyword.Bluemix_notm}} CLI 和发行说明](/docs/cli/reference/ibmcloud/all_versions.html)
* [{{site.data.keyword.Bluemix_notm}} CLI 命令用法文档](/docs/cli/reference/ibmcloud/bx_cli.html)
