...
請使用下列指令來管理 {{site.data.keyword.Bluemix}} 標準基礎架構裸機硬體伺服器。
{: shortdesc}

<table summary="按字母順序排列的  {{site.data.keyword.Bluemix_notm}} 標準基礎架構裸機伺服器指令，其鏈結提供指令的相關資訊">
 <tbody>
 <tr>
