...
# 用來管理 {{site.data.keyword.Bluemix_notm}} 基礎架構安全的指令

<table summary="按字母順序排序的一般 {{site.data.keyword.Bluemix_notm}} 基礎架構指令，其鏈結提供指令的相關資訊">
<caption>表 1. {{site.data.keyword.Bluemix_notm}} 基礎架構 security 指令</caption>

 <thead>
 <th colspan="5">{{site.data.keyword.Bluemix_notm}} 基礎架構 security 指令</th>
 </thead>
 <tbody>
 <tr>
