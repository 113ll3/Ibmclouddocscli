...
이어지는 지시사항은 Cloud Foundry(cf) CLI 플러그인으로 작업하기에 대한 것입니다. {{site.data.keyword.Bluemix_notm}} CLI 플러그인과 함께 플러그인을 사용하려면 [{{site.data.keyword.Bluemix_notm}} CLI용 {{site.data.keyword.vpn_short}} 플러그인](https://console.{DomainName}/docs/cli/plugins/bx_vpn/index.html)을 참조하십시오.

## cf CLI 플러그인 설치
시작하기 전에 cf CLI를 설치하십시오. 세부사항은 [Cloud Foundry 명령행 인터페이스](https://console.{DomainName}/docs/cli/downloads.html)를 참조하십시오.
...
1. [IBM Bluemix CLI 플러그인 저장소](http://plugins.ng.bluemix.net/ui/repository.html#cf-plugins)에서 사용자의 플랫폼에 해당하는 {{site.data.keyword.vpn_short}} 플러그인을 다운로드하십시오. 
