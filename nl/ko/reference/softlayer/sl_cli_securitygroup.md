...
# Securitygroup CLI 명령

<table summary="해당 명령에 대한 자세한 정보를 제공하는 링크가 있는 알파벳순으로 정렬된 일반 {{site.data.keyword.BluSoftlayer_notm}} 인프라 명령">
<caption>표 1. {{site.data.keyword.BluSoftlayer_notm}} 인프라 Securitygroup 명령</caption>
 <thead>
 <th colspan="5">{{site.data.keyword.BluSoftlayer_notm}} 인프라 Securitygroup 명령</th>
 </thead>
 <tbody>
 <tr>
