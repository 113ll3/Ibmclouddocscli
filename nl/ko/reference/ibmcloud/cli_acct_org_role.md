...
<strong>명령 옵션</strong>:
   ...
   <dd>계정 소유자 이름입니다. 지정된 사용자가 소유한 계정의 조직을 나열하십시오. 지정되지 않은 경우 현재 계정으로 기본값이 지정됩니다. 'all'로 설정되면 모든 계정 아래 조직이 나열됩니다. 이 옵션은 '-c'와 배타적입니다.</dd>
   </dl>
...
<dl>
  ...
  <dd>Softlayer 계정의 서비스 엔드포인트 연결을 사용하거나 사용 안함으로 설정합니다.</dd>
</dl>
