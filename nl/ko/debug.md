...
{{site.data.keyword.Bluemix_notm}}용 IBM Eclipse 도구 플러그인을 사용하여 애플리케이션을 배치하는 경우, Eclipse 도구의 **콘솔** 탭에서 cf 로그 출력과 유사한 로그를 볼 수 있습니다. 별도의 Eclipse 창을 열어 애플리케이션을 배치할 때 `the logs`를 추적할 수도 있습니다.
