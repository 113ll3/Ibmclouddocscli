...
<dt>Efetuar login</dt>
<dd>Use o comando **`ibmcloud login`** para efetuar login. Se você efetuar login com um ID federado, use a opção **`--sso`** para autenticar com uma senha única ou use a opção **`--apikey`** para autenticar com uma chave de API.</dd>
<dt>Destino</dt>
...
<dt>--output FORMAT</dt>
<dd>O formato de saída especificado. JSON é o único formato suportado.</dd>
</dl>
