...
<dl>
  ...
  <dd>Nome ou ID do serviço. Para listar as ofertas de serviços, use o [comando](/docs/cli/reference/ibmcloud?topic=cloud-cli-ibmcloud_catalog#ibmcloud_catalog_service_marketplace) `ibmcloud catalog service-marketplace`.</dd>
