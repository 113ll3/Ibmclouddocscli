...
# Comandos da CLI para gerenciamento de catálogo, plug-ins e configurações de faturamento
...
<caption>Tabela 1. Comandos para gerenciar as configurações de catálogo, plug-ins, faturamento e segurança do {{site.data.keyword.Bluemix_notm}}</caption>
 ...
 <tbody>
 <tr>
  <td>[Ibmcloud de procura de catálogo](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_search)</td>
  <td>[ibmcloud catalog entry](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_entry)</td>
  <td>[Create-ibmcloud entrada no catálogo](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_entry_create)</td>
  <td>[Update-ibmcloud entrada no catálogo](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_entry_update)</td>
  <td>[Delete-entrada no catálogo ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_entry_delete)</td>
 </tr>
 <tr>
  <td>[Catalog entry-visibility ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_entry_visibility)</td>
  <td>[Catalog service-marketplace ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_service_marketplace)</td>
  ...
  <td>[Modelo do catálogo ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_template)</td>
 </tr>
 <tr>
  <td>[Catalog template-run ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_template_run)</td>
  <td>[Locais do catálogo ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_locations)</td>
  <td>[Execução de catálogo ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_runtime)</td>
  <td>[Ibmcloud tempos no catálogo](ic_cli_cat_plugin_billing.html#ibmcloud_catalog_runtimes)</td>
  <td>[ibmcloud plugin repos](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_repos)</td>
</tr>
<tr>
  <td>[Plugin repo-add ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_repo_add)</td>
  <td>[Plugin repo-remove ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_repo_remove)</td>
  <td>[ibmcloud plugin repo-plugins](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_repo_plugins)</td>
  <td>[Plugin ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_repo_plugin)</td>
...
<tr>
  ...
  <td>[Plugin install ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_plugin_install)</td>
  ...
  <td>[Uso de conta de cobrança ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_billing_account_usage)</td>
</tr>
<tr>
  <td>[Billing org-usage ibmcloud](ic_cli_cat_plugin_billing.html#ibmcloud_billing_org_usage)</td>
