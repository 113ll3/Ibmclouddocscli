...
# Comandos da CLI para gerenciamento de serviços
...
<caption>Tabela 1. Comandos para gerenciamento de serviços do {{site.data.keyword.Bluemix_notm}}</caption>
 ...
 <tbody>
 <tr>
 <td>[As ofertas de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_offerings)</td>
 <td>[Ibmcloud lista de serviços](ic_cli_services.html#ibmcloud_service_list)</td>
 <td>[Ibmcloud show de serviço](ic_cli_services.html#ibmcloud_service_show)</td>
 <td>[Criar serviço ibmcloud](ic_cli_services.html#ibmcloud_service_create)</td>
 <td>[Atualização de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_update)</td>
 </tr>
 <tr>
 <td>[ibmcloud service delete](ic_cli_services.html#ibmcloud_service_delete)</td>
 <td>[Renomeação de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_rename)</td>
 <td>[Ligação de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_bind)</td>
 <td>[Service unbind ibmcloud](ic_cli_services.html#ibmcloud_service_unbind)</td>
 <td>[Create-chave de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_key_create)</td>
 </tr>
 <tr>
 <td>[Service key-delete ibmcloud](ic_cli_services.html#ibmcloud_service_key_delete)</td>
 <td>[Chaves de serviço ibmcloud](ic_cli_services.html#ibmcloud_service_keys)</td>
 <td>[Service key-show ibmcloud](ic_cli_services.html#ibmcloud_service_key_show)</td>
 <td>[Serviço ibmcloud user-provided-create](ic_cli_services.html#ibmcloud_service_user_provided_create)</td>
 <td>[Ibmcloud de serviço do usuário a atualização fornecida](ic_cli_services.html#ibmcloud_service_user_provided_update)</td>
 </tr>
  </tbody>
 </table>
