...
# Comandos da CLI da VPN do Internet Protocol Security
...
<caption>Tabela 1. Comandos VPN do Internet Protocol Security de infraestrutura do {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
 ...
 <td>[Sl ipsec list ibmcloud](/docs/cli/reference/softlayer/sl_cli_ipsec_vpn.html#sl_ipsec_list)</td>
