...
# Comandos da CLI do Virtual Server
...
<caption>Tabela 1. Comandos do servidor virtual de infraestrutura do {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
 ...
 <td>[Sl vs capture ibmcloud](/docs/cli/reference/softlayer/sl_cli_virtual_server.html#sl_vs_capture)</td>
 ...
 <td>[Sl vs power-ibmcloud](/docs/cli/reference/softlayer/sl_cli_virtual_server.html#sl_vs_power_on)
 ...
 <td>[Sl vs rescue ibmcloud](/docs/cli/reference/softlayer/sl_cli_virtual_server.html#sl_vs_rescue)</td>
 </tr>
 <tr>
