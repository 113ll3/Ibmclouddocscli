...
# Comandos da CLI do balanceador de carga
...
<caption>Tabela 1. Comandos do balanceador de carga de infraestrutura do {{site.data.keyword.BluSoftlayer_notm}}</caption>
 <thead>
