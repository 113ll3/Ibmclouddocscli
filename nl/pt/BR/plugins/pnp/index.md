...
# Plug-in de peering de rede privada para a CLI do {{site.data.keyword.cloud_notm}}
{: #private_network_cli}

Use a interface da linha de comandos (CLI) de peering de rede privada para configurar e gerenciar o peering de rede privada entre dois espaços do {{site.data.keyword.cloud}}. O peerring de rede privada é suportado para o IBM Containers (contêineres de docker). Os espaços do {{site.data.keyword.cloud_notm}} podem ser localizados em diferentes zonas de disponibilidade na mesma região ou podem ser localizados nas diferentes regiões. O plug-in da CLI do peering de rede privada está disponível para uso com o plug-in do {{site.data.keyword.cloud_notm}} CLI.
...
Antes de iniciar, crie espaços do {{site.data.keyword.cloud_notm}}. Assegure-se de que cada contêiner em um espaço tenha um endereço IP de uma rede diferente.

**Nota:** depois de usar o peering de rede privada com um espaço do {{site.data.keyword.cloud_notm}}, se você precisar excluir o espaço, primeiro exclua as conexões de peering de rede privada nesse espaço.

Para iniciar, instale o {{site.data.keyword.cloud_notm}} CLI. Consulte
[CLI do IBM Cloud](/docs/cli?topic=cloud-cli-ibmcloud-cli) para obter detalhes.
...
### Instalar localmente
Faça download do plug-in de peering de rede privada para sua plataforma por meio do [repositório de plug-in da CLI do {{site.data.keyword.cloud_notm}}](https://plugins.cloud.ibm.com/ui/repository.html){: new_window}![Ícone de link externo](../../../icons/launch-glyph.svg "Ícone de link externo").
...
### Instale usando o repositório do {{site.data.keyword.cloud_notm}}

Siga essas etapas para instalar o plug-in usando o repositório do {{site.data.keyword.cloud_notm}}:

1. Inclua o terminal de registro do plug-in do {{site.data.keyword.cloud_notm}}:
	```
