...
As instruções a seguir são para trabalhar com o plug-in da CLI do Cloud Foundry (cf). Para usar o plug-in com o plug-in da CLI do {{site.data.keyword.Bluemix_notm}}, veja [Plug-in do {{site.data.keyword.vpn_short}} para a CLI do {{site.data.keyword.Bluemix_notm}}](https://console.{DomainName}/docs/cli/plugins/bx_vpn/index.html).

## Instalar o plug-in cf CLI
Antes de iniciar, instale o cf CLI. Veja [Interface da linha de comandos do Cloud Foundry](https://console.{DomainName}/docs/cli/downloads.html) para obter detalhes.
...
1. Faça download do plug-in {{site.data.keyword.vpn_short}} para sua plataforma por meio do [Repositório de plug-in da CLI do IBM Bluemix](http://plugins.ng.bluemix.net/ui/repository.html#cf-plugins).
...
1. Inclua o repositório do Bluemix nos repositórios do Cloud Foundry CLI. Utilize o seguinte comando:
...
2. Execute o seguinte comando:
	...
	```
## Lista de comandos de serviço IBM VPN
